...
var Types = (_Types = {}, _defineProperty(_Types, DataTypes.Int8, { type: DataTypes.Int8, byteLength: 1 }), _defineProperty(_Types, DataTypes.Uint8, { type: DataTypes.Uint8, byteLength: 1 }), _defineProperty(_Types, DataTypes.Int16, { type: DataTypes.Int16, byteLength: 2 }), _defineProperty(_Types, DataTypes.Uint16, { type: DataTypes.Uint16, byteLength: 2 }), _defineProperty(_Types, DataTypes.Int32, { type: DataTypes.Int32, byteLength: 4 }), _defineProperty(_Types, DataTypes.Uint32, { type: DataTypes.Uint32, byteLength: 4 }), _defineProperty(_Types, DataTypes.Float32, { type: DataTypes.Float32, byteLength: 4 }), _defineProperty(_Types, DataTypes.Float64, { type: DataTypes.Float64, byteLength: 4 }), _defineProperty(_Types, DataTypes.Array, function (def, length) {
  ...
  var write = function write(dataView, offset, value) {
